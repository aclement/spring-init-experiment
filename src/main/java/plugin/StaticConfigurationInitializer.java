...
public class StaticConfigurationInitializer implements Plugin {
    ...
    public static void main(String[] args) {
        new StaticConfigurationInitializer().apply(new ByteBuddy().rebase(SampleConfiguration.class), TypeDescription.ForLoadedType.of(SampleConfiguration.class), ClassFileLocator.NoOp.INSTANCE).make();
    }
}
