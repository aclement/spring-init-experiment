...
public class WebFluxAutoConfiguration_EnableWebFluxConfigurationInitializer
		implements ApplicationContextInitializer<GenericApplicationContext> {
	@Override
	public void initialize(GenericApplicationContext context) {
		if (context.getBeanFactory().getBeanNamesForType(
				WebFluxAutoConfiguration.EnableWebFluxConfiguration.class).length == 0) {
			...
			context.registerBean("webFluxConversionService",
					FormattingConversionService.class,
					() -> context.getBean(
							WebFluxAutoConfiguration.EnableWebFluxConfiguration.class)
							.webFluxConversionService());
			context.registerBean("webFluxValidator", Validator.class,
					() -> context.getBean(
							WebFluxAutoConfiguration.EnableWebFluxConfiguration.class)
							.webFluxValidator());
			...
			context.registerBean("requestMappingHandlerAdapter",
					RequestMappingHandlerAdapter.class,
					() -> context.getBean(
							WebFluxAutoConfiguration.EnableWebFluxConfiguration.class)
							.requestMappingHandlerAdapter());
			context.registerBean("requestMappingHandlerMapping",
			...
			context.registerBean("resourceUrlProvider", ResourceUrlProvider.class,
					() -> context.getBean(
							WebFluxAutoConfiguration.EnableWebFluxConfiguration.class)
							.resourceUrlProvider());
			context.registerBean("responseBodyResultHandler",
					ResponseBodyResultHandler.class,
					() -> context.getBean(
							WebFluxAutoConfiguration.EnableWebFluxConfiguration.class)
							.responseBodyResultHandler());
			context.registerBean("responseEntityResultHandler",
					ResponseEntityResultHandler.class,
					() -> context.getBean(
							WebFluxAutoConfiguration.EnableWebFluxConfiguration.class)
							.responseEntityResultHandler());
			context.registerBean("responseStatusExceptionHandler",
			...
			context.registerBean("serverResponseResultHandler",
			...
			context.registerBean("webFluxContentTypeResolver",
